...
#define PANEL_HEIGHT 32      /* 0 for no space for panel, thus no panel */
...
#define FOCUS "#e7c26f"      /* focused window border color    */
#define UNFOCUS "#5a5857"    /* unfocused window border color  */
...
static const AppRule rules[] = {
    ...
    {"Gimp", 0, False, False},       {"Gcolor3", 0, False, True}, {"Gnome-screenshot", 0, False, True},
    {"Pavucontrol", 0, False, True}, {"Lxrandr", 0, False, True}, {"Lxappearance", 0, False, True},
};
...
#define DESKTOPCHANGE(K, N) {MOD1, K, change_desktop, {.i = N}}, {MOD1 | ShiftMask, K, client_to_desktop, {.i = N}},
